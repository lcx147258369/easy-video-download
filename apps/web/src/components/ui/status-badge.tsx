import type { TaskStatus } from "@video/shared";

import { cn } from "./cn";

const toneByStatus: Record<TaskStatus, { dot: string; text: string }> = {
...
export function StatusBadge({
  ...
  return (
    <span
      className={cn(
        "inline-flex items-center gap-2 text-[13px] font-semibold leading-none",
        tone.text
      )}
    >
